...
export default function HomePage() {
  return (
    <main className="min-h-dvh *:">
      <header className="sticky top-0 z-50 border-b bg-white/80 backdrop-blur z-90">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2 text-xs">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group flex items-center gñadidap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-600 transition-all hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
